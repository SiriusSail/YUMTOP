...
export default {
  ...
  created() {
    ...
    // console.log("userAgent: " + navigator.userAgent + "<br><br>");
    // console.log("appName: " + navigator.appName + "<br><br>");
    // console.log("appCodeName: " + navigator.appCodeName + "<br><br>");
    // console.log("appVersion: " + navigator.appVersion + "<br><br>");
    // console.log("appMinorVersion: " + navigator.appMinorVersion + "<br><br>");
    // console.log("platform: " + navigator.platform + "<br><br>");
    // console.log("cookieEnabled: " + navigator.cookieEnabled + "<br><br>");
    // console.log("onLine: " + navigator.onLine + "<br><br>");
    // console.log("userLanguage: " + navigator.language + "<br><br>");
    // console.log("mimeTypes.description: " + navigator.mimeTypes[1].description + "<br><br>");
    // console.log("mimeTypes.type: " + navigator.mimeTypes[1].type + "<br><br>");
    // console.log("plugins.description: " + navigator.plugins[3].description + "<br><br>");
  },
  methods: {
    getStoreAll() {
      getAll().then(res => {
